...
def parse_certificate_text(text: str,certificate_type: str="AUTO") -> CertificateExtraction:
    ...
    aliases={
      "certificate_id":[r"certificate\s*(?:no\.?|number)\s*[:#=]?\s*([A-Z0-9][A-Z0-9./_-]*)",r"our\s+ref(?:erence)?\s*[:=]\s*([A-Z0-9][A-Z0-9./_-]*)",r"report\s+(?:no\.?|number)\s*[:#=]\s*([A-Z0-9][A-Z0-9./_-]*)"],
...
def parse_certificate_pdf(pdf_path: str|Path,certificate_type: str="AUTO"):
