...
def test_main_line_uses_spliced_value_when_presentation_is_spliced():
    main = component_from_certificate(
        component_id="6FT0540120",
        component_type="MAIN LINE",
        certificate_id="W225-6918",
        break_load_linear_kn=1220.78,
        break_load_spliced_kn=1098.70,
...
def test_tail_loop_around_bollard_uses_grommet_value_not_spliced_value():
    tail = component_from_certificate(
        component_id="355600999x01",
        component_type="TAIL",
        certificate_id="W225-6919",
        break_load_spliced_kn=629.00,
        break_load_grommet_kn=1006.40,
...
def test_composite_assembly_selects_tail_grommet_as_weak_link():
    main = component_from_certificate(
        component_id="6FT0540120",
        component_type="MAIN LINE",
        certificate_id="W225-6918",
    ...
    geo = component_from_certificate(
        component_id="663260992",
        component_type="GEOLINK/LASHING",
        certificate_id="W225-6920",
        break_load_spliced_kn=1073.30,
        final_presentation="spliced one end",
    )
...
def test_missing_component_strength_does_not_invent_weak_link():
    main = component_from_certificate(
        ...
        component_type="MAIN LINE",
        certificate_id="CERT",
        break_load_spliced_kn=1000.0,
        final_presentation="spliced both ends",
    )
    unknown = component_from_certificate(
        component_id="TAIL",
        component_type="TAIL",
